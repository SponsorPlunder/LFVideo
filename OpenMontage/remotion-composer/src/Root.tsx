...
export const Root: React.FC = () => {
  return (
    <>
      ...
      <Composition
        id="TimelineScene"
        component={TimelineScenePreview}
...
const TimelineScenePreview: React.FC = () => (
  <TimelineScene
    eyebrow="底层机制"
...
const TableScenePreview: React.FC = () => (
  <TableScene
    eyebrow="功能对比"
    title="Cursor vs Windsurf"
    headers={["对比项", "Cursor", "Windsurf"]}
    rows={[
      { feature: "工作流编排", cursor: "Rules (.mdc)", windsurf: "Workflows (.md)", win: "windsurf" },
      { feature: "多文件编辑", cursor: "Composer", windsurf: "Agent Box", win: "neutral" },
    ]}
    background="gradient"
  />
);
